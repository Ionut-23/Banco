public class Lanzador {
    public static void main(String[] args) throws InterruptedException{
        ...
        for (int i=0; i<NUM_OPS_CON_100;i++){
            HiloCuenta ingresa = new HiloCuenta(cuenta, 100);
            HiloCuenta retira  = new HiloCuenta(cuenta, -100);
        ...
        for (int i=0; i<NUM_OPS_CON_50;i++){
            HiloCuenta ingresa = new HiloCuenta(cuenta, 50);
            HiloCuenta retira  = new HiloCuenta(cuenta, -50);
        ...
        for (int i=0; i<NUM_OPS_CON_20;i++){
            HiloCuenta ingresa = new HiloCuenta(cuenta, 20);
            HiloCuenta retira  = new HiloCuenta(cuenta, -20);
